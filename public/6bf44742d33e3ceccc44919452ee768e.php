<?php /*a:1:{s:28:"../view/root/class-list.html";i:1609476629;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加班级','/',430,550)"><i class="layui-icon"></i>添加</button>
                    <button class="layui-btn layui-btn-normal" onclick="window.location.href='/tools/class_list'">显示所有</button>
                </div>
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlentities($key['tid']); ?></td>
                            <td class="td-manage">
                                <a title="修改"  onclick="xadmin.open('编辑','/',430,550);" href="javascript:;">
                                    <i class="layui-icon">&#xe642;</i>
                                </a>
                                <a title="删除" onclick="student_del(this,'<?php echo htmlentities($key['cno']); ?>')" href="javascript:;">
                                    <i class="layui-icon">&#xe640;</i>
                                </a>
                            </td>
                        </tr>
        ...
        function() {
            ...
            form.on('submit(sreach)',
                function(data) {
                    ...
                    window.location.href="/tools/class_list?choose="+data.field.optioin+"&message="+data.field.message;
                    return false;
                });
            //跳转页面
            form.on('submit(goto)',
                function(data) {
                    window.location.href="/class_list?id="+(data.field.message-1);
                    return false;
                });
        });
