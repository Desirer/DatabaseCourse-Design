<?php /*a:1:{s:31:"../view/teacher/exam-list2.html";i:1611819773;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn layui-btn-normal" onclick="window.location.href='/ttools/exam_list2'">显示所有</button>
                </div>
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                <a title="批改"  onclick="parent.xadmin.add_tab('<?php echo htmlentities($key['name']); ?>作文批改','/page/exam_student_list?eid=<?php echo htmlentities($key['eid']); ?>&cno=<?php echo htmlentities($key['cno']); ?>');" href="javascript:;">
