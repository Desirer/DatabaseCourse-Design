<?php /*a:1:{s:29:"../view/root/member-list.html";i:1608550790;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加学生','/page/member_add',430,550)"><i class="layui-icon"></i>录入</button>
                            <button class="layui-btn layui-btn-normal" onclick="window.location.href='/page/member_list'">显示所有</button>
                        </div>
                        <div class="layui-card-body layui-table-body layui-table-main">
                            <table class="layui-table layui-form">
                                ...
                                <?php foreach($list as $key): ?>
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="id" value="<?php echo htmlentities($key['sid']); ?>"   lay-skin="primary">
                                    </td>
                                    ...
                                    <td class="td-manage">
                                      <a title="编辑"  onclick="xadmin.open('编辑','/page/member_edit?id=<?php echo htmlentities($key['sid']); ?>',430,550);" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
                                      <a title="删除" onclick="member_del(this,'<?php echo htmlentities($key['sid']); ?>')" href="javascript:;">
                                        <i class="layui-icon">&#xe640;</i>
                                      </a>
                                    </td>
                                  </tr>
                        ...
                        <div class="layui-card-body ">
                            <div class="page">
                                ...
                                <?php endif; 
                                        ...
                                        for($i=($id-3);$i<=$id;$i++){
                                            if($i>=1){
                                                if($i==($id+1))
                                                    ...
                                                    echo '<a class="num" href="/page/member_list?id='.($i-1).'">'.$i.'</a>';
                                            }
                                        }
                                        for($i=($id+1);$i<=($id+5);$i++){
                                            if($i<=$page){
                                   ...
                                   if(($id+1)!=$page): ?>
                                    <a class="next" href="/page/member_list?id=<?php echo htmlentities($id+1); ?>">下一页</a>
                                <?php endif; ?>
                                    <div class="layui-inline layui-show-xs-block">
            ...
            function() {
                ...
                form.on('submit(sreach)',
                    function(data) {
                        ...
                        window.location.href="/page/member_list?choose="+data.field.optioin+"&message="+data.field.message;
                        return false;
                    });
                //跳转页面
                form.on('submit(goto)',
                    function(data) {
                       window.location.href="/page/member_list?id="+(data.field.message-1);
                        return false;
                    });
            });
