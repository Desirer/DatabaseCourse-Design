<?php /*a:1:{s:31:"../view/teacher/exam-list3.html";i:1609919109;}*/ ?>
<!DOCTYPE html>
...
<!--                    <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button>-->
                    <button class="layui-btn" onclick="xadmin.open('添加考试','/page/exam_add',430,550)"><i class="layui-icon"></i>添加</button>
                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td>功能待完成</td>
                            <td class="td-manage">
                                <a title="批改"  onclick="parent.xadmin.add_tab('<?php echo htmlentities($key['name']); ?>历史成绩','/page/exam_score_list?eid=<?php echo htmlentities($key['eid']); ?>&cno=<?php echo htmlentities($key['cno']); ?>');" href="javascript:;">
    ...
    layui.use(['form', 'layer'],
        function() {
            ...
            form.on('submit(search)',
                function(data) {
                    window.location.href="/ttools/exam_list2?choose="+data.field.optioin+"&message="+data.field.message;
                    return false;
                });
            //跳转页面
            form.on('submit(goto)',
                function(data) {
                    window.location.href="/ttools/exam_list2?id="+(data.field.message-1);
                    return false;
                });
        });
