<?php /*a:1:{s:18:"../view/index.html";i:1608551429;}*/ ?>
<!doctype html>
    ...
    <body class="index mybg">
        ...
        <div class="container">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    <a href="javascript:;">欢迎您，<?php echo htmlentities($name); ?>管理员</a>
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
            ...
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('学生信息','/page/member_list')">
                                    <i class="layui-icon">&#xe770;</i>
                                    <cite>学生信息管理</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('教师信息','/datatest/abc')">
                                    <i class="iconfont">&#xe770;</i>
                                    <cite>教师信息管理</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('人员信息','grade-list')">
                                    <i class="iconfont">&#xe6b2;</i>
                                    <cite>班级人员</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('无','grade-list')">
                                    <i class="iconfont">&#xe6b2;</i>
                                    <cite>无</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('学生成绩','grade-list')">
                                    <i class="iconfont">&#xe6b2;</i>
                                    <cite>学生成绩</cite></a>
                            </li>
                        </ul>
