<?php /*a:1:{s:33:"../view/teacher/exam-content.html";i:1611814368;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <li id="<?php echo htmlentities($listen['pid']); ?>">
                        ...
                        <div class="test_content_nr_main">
                            <ul>
                                ...
                                <li class="option">
                                    <input type="radio" class="radioOrCheck" name="<?php echo htmlentities($listen['pid']); ?>"id="0_answer_<?php echo htmlentities($listen['pid']); ?>_option_b" value="a" />
                                ...
                                <li class="option">
                                    <input type="radio" class="radioOrCheck" name="<?php echo htmlentities($listen['pid']); ?>"id="0_answer_<?php echo htmlentities($listen['pid']); ?>_option_c" value="a" />
                                ...
                                <li class="option">
                                    <input type="radio" class="radioOrCheck" name="<?php echo htmlentities($listen['pid']); ?>"id="0_answer_<?php echo htmlentities($listen['pid']); ?>_option_d" value="a" />
                                    <label for="0_answer_<?php echo htmlentities($listen['pid']); ?>_option_d">D.<p class="ue" style="display: inline;"><?php echo htmlentities($listen['a']); ?></p></label>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li id="<?php echo htmlentities($read['pid']); ?>">
                        ...
                        <div class="test_content_nr_main">
                            <ul>
                                ...
                                <li class="option">
                                    <input type="radio" class="radioOrCheck" name="<?php echo htmlentities($read['pid']); ?>" id="0_answer_<?php echo htmlentities($read['pid']); ?>_option_b" value="a" />
                                ...
                                <li class="option">
                                    <input type="radio" class="radioOrCheck" name="<?php echo htmlentities($read['pid']); ?>" id="0_answer_<?php echo htmlentities($read['pid']); ?>_option_c" value="a" />
                                ...
                                <li class="option">
                                    <input type="radio" class="radioOrCheck" name="<?php echo htmlentities($read['pid']); ?>" id="0_answer_<?php echo htmlentities($read['pid']); ?>_option_d" value="a" />
                                    <label for="0_answer_<?php echo htmlentities($read['pid']); ?>_option_d">D.<p class="ue" style="display: inline;"><?php echo htmlentities($read['a']); ?></p></label>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li id="<?php echo htmlentities($write['wid']); ?>">
                        ...
                        <div class="test_content_nr_main">
                            <ul>
                                ...
                                <textarea name="<?php echo htmlentities($write['wid']); ?>" id="0_answer_<?php echo htmlentities($write['wid']); ?>_option_a"></textarea>
